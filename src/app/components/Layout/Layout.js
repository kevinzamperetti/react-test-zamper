...
class Layout extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            pageTitle: null,
            pageDescription: 'Sistema de Indicação de Pessoas', //config.siteDescription,
            pageKeywords: 'react dashboard seed bootstrap' //config.siteKeywords
        };
